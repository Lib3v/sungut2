...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/Lib3v/otw2/main/ipmini > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/Lib3v/otw2/main/ipmini | grep $MYIP | awk '{print $2}')
Isadmin=$(curl -sS https://raw.githubusercontent.com/Lib3v/otw2/main/ipmini | grep $MYIP | awk '{print $5}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/Lib3v/otw2/main/ipmini | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
Exp=$(curl -sS https://raw.githubusercontent.com/Lib3v/otw2/main/ipmini | grep $MYIP | awk '{print $3}')
fi
export RED='\033[0;31m'
...
rm /opt/.ver
version_up=$( curl -sS https://raw.githubusercontent.com/Lib3v/otw2/main/version)
...
serverV=$( curl -sS https://raw.githubusercontent.com/Lib3v/otw2/main/version)
if [ "$Isadmin" = "ON" ]; then
...
echo -e "$COLOR1└─────────────────────────────────────────────────┘$NC"
echo -e "$COLOR1┌────────────────────── BY ───────────────────────┐${NC}"
echo -e "$COLOR1│${NC}              • BRINGAS - TUNNEL •            $COLOR1│$NC"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}" 
echo -e ""
